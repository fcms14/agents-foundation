...
- **Load / performance** — Artillery scenarios for performance-sensitive endpoints (e.g. high-traffic ingestion, feeds, or compute-heavy endpoints) with explicit latency/throughput assertions.
